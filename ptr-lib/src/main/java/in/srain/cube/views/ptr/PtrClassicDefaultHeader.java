...
public class PtrClassicDefaultHeader extends FrameLayout implements PtrUIHandler {
    ...
    private TextView mLoadContentTv;
...
//    private View mProgressBar;
    ...
    private String cube_ptr_pull_down_to_refresh;
    private String cube_ptr_pull_down;
    ...
    protected void initViews(AttributeSet attrs) {
        cube_ptr_pull_down_to_refresh = getResources().getString(R.string.cube_ptr_pull_down_to_refresh);
        cube_ptr_pull_down = getResources().getString(R.string.cube_ptr_pull_down);
        ...
        mProgressBarLayout = (LinearLayout) header.findViewById(R.id.ptr_classic_header_rotate_view_progressbar_layout);
        mProgressBar = (ProgressBar) header.findViewById(R.id.ptr_classic_header_rotate_view_progressbar);
        mLoadContentTv = (TextView) header.findViewById(R.id.mContentTv);
        resetView();
    }
    ...
    public void setRefreshViewConfig(int arrowImgId, Drawable progressBarDrawable,int textColor){
        mRotateView.setImageResource(arrowImgId);
        mProgressBar.setIndeterminateDrawable(progressBarDrawable);
        mTitleTextView.setTextColor(textColor);
        mLastUpdateTextView.setTextColor(textColor);
        mLoadContentTv.setTextColor(textColor);
    }
    ...
    public void setCube_ptr_pull_down(String cube_ptr_pull_down) {
        this.cube_ptr_pull_down = cube_ptr_pull_down;
    }

    public void setCube_ptr_pull_down_to_refresh(String cube_ptr_pull_down_to_refresh) {
        this.cube_ptr_pull_down_to_refresh = cube_ptr_pull_down_to_refresh;
    }
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        ...
        if (frame.isPullToRefresh()) {
            mTitleTextView.setText(cube_ptr_pull_down_to_refresh);
        } else {
            mTitleTextView.setText(cube_ptr_pull_down);
        }
    }
