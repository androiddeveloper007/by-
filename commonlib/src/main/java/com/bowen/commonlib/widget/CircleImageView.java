...
public class CircleImageView extends AppCompatImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        type = a.getInt(R.styleable.CircleImageView_image_type, TYPE_CIRCLE);
        mRadius = a.getDimensionPixelOffset(R.styleable.CircleImageView_image_radius, DEFAULT_BORDER_WIDTH);
        a.recycle();
    ...
    private void setup() {
        ...
        if (type == TYPE_ROUND) {
            ...
            mDrawableRect.set(0, 0, mBorderRect.width(), mBorderRect.height());
        } else {
