...
public abstract class TosAdapterView<T extends Adapter> extends ViewGroup {
    ...
    /**
     * Returns the adapter currently associated with this com.jingchang.chongwu.common.widget.
     * 
    ...
    /**
     * Sets the adapter that provides the data and the views to represent the data in this com.jingchang.chongwu.common.widget.
     * 
