...
package com.bowen.commonlib.widget.wheel;
 ...
 * {@link } as the background for each View given to
...
public class TosGallery extends TosAbsSpinner implements GestureDetector.OnGestureListener,
    ...
    protected boolean getChildStaticTransformation(View child, Transformation t) {
    	...
    	if(child == mSelectedChild){
        	...
        	tv.setTextColor(getResources().getColor(R.color.text_lgtgray));
        }
    	t.clear();
  ...
  //获取父控件中心点 X 的位置  
   protected int getCenterOfCoverflow() {  
           return ((getHeight() - getPaddingTop() - getPaddingBottom()) >> 1) + getPaddingTop();  
   }  
    ...
    public void dispatchSetSelected(boolean selected) {
         ...
         * com.jingchang.chongwu.common.widget itself has a selected state to give to its children.
         */
    }
