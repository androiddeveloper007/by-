...
public class MagicIndicator extends FrameLayout {
    ...
    public MagicIndicator(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, IPagerNavigator mNavigator) {
        super(context, attrs, defStyleAttr);
        this.mNavigator = mNavigator;
    }

    @TargetApi(21)
    public MagicIndicator(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes, IPagerNavigator mNavigator) {
