...
/**
 * Created by zhuzhipeng on 2017/3/12.
 */
...
//            this.mExpandedDrawable.setBounds(0, 0, mExpandedDrawable.getIntrinsicWidth(), mExpandedDrawable.getIntrinsicHeight());
            int textHeight = ScreenSizeUtil.dp2px(14);
            this.mExpandedDrawable.setBounds(0, 0, textHeight, textHeight);
        }
    }
...
//            this.mCollapsedDrawable.setBounds(0, 0, mCollapsedDrawable.getIntrinsicWidth(), mCollapsedDrawable.getIntrinsicHeight());
            int textHeight = ScreenSizeUtil.dp2px(14);
            this.mCollapsedDrawable.setBounds(0, 0, textHeight, textHeight);
        }
    }
...
//                    spannable.length() - tipsLen, spannable.length(), Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
            ...
            spannable.setSpan(new ImageSpan(drawable, ImageSpan.ALIGN_BASELINE),
                    spannable.length() - 1, spannable.length(), Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
            // 设置点击事件
//            spannable.setSpan(mClickableSpan, spannable.length() - tipsLen, spannable.length(), Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
            spannable.setSpan(mClickableSpan, spannable.length() - 3, spannable.length(), Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
        }
    }
